...
describe BugsnagData do
  ...
  describe "Bugsnag API" do
    ...
    it "should retrieve a projects errors" do
      ...
      expect(project_errors[0]["last_message"]).to eq("Uncaught TypeError: Cannot read property 'prototype' of undefined")
      ...
      expect(project_errors[1]["last_message"]).to eq("this.items[0] is undefined")
      ...
      expect(project_errors[2]["last_message"]).to eq("'null' is not an object (evaluating 'a.connection.close')")
